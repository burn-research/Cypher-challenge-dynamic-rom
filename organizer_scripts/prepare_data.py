...
RAW_SIMULATIONS = [
    dict(name="sineSweep_f1_f80_A02", raw_data_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/sineSweep_f1_f80_A02.npy",
         raw_grid_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/grid_0_0 6.vtu",
         split="train", signal="sweep", A=0.2, f=None, dt=5e-4, t0=0.0),
    dict(name="sineSweep_f1_f80_A04", raw_data_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/sineSweep_f1_f80_A04.npy",
         raw_grid_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/grid_0_0 6.vtu",
         split="train", signal="sweep", A=0.4, f=None, dt=5e-4, t0=0.0),

    dict(name="step_A03", raw_data_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/step_A03.npy",
         raw_grid_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/grid_0_0 6.vtu",
         split="valid", signal="step", A=0.3, f=None, dt=5e-4, t0=0.0),
    dict(name="sine_f40_A05", raw_data_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/sine_f40_A05.npy",
         raw_grid_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/grid_0_0 6.vtu",
    ...
    dict(name="step_A05", raw_data_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/step_A05.npy",
         raw_grid_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/grid_0_0 6.vtu",
         split="test", signal="step", A=0.5, f=None, dt=5e-4, t0=0.0),
    dict(name="sine_f10_A03", raw_data_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/sine_f10_A03.npy",
         raw_grid_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/grid_0_0 6.vtu",
         split="test", signal="sine", A=0.3, f=10.0, dt=5e-4, t0=0.0),
    dict(name="sine_f10_A05", raw_data_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/sine_f10_A05.npy",
         raw_grid_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/grid_0_0 6.vtu",
         split="test", signal="sine", A=0.5, f=10.0, dt=5e-4, t0=0.0),
    dict(name="sine_f40_A03", raw_data_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/sine_f40_A03.npy",
         raw_grid_path="/globalsc/ulb/atm/baffetti/data_challenge/Data/grid_0_0 6.vtu",
